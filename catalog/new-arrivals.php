  ...
  <main>
    <section id="new-arrivals">
      ...
      <div id="new-products">
        ...
        <?php
          echo generateProductCard(13, "Generic Name", 9.99);
          echo generateProductCard(12, "Generic Name", 9.99);
          echo generateProductCard(3, "Generic Name", 9.99);
          echo generateProductCard(18, "Generic Name", 9.99);
        ?>
