    ...
    <section id="faq" class="common height">
      ...
      <div id="faq-content" class="common subsection">
        <div class="left-side">
          ...
          <h3 id="q1" class="common accordion padded">How long does delivery take to canyon bottoms?<img class="icon" src="img/icons/dropdown.png"></h3>
          <p class="response">Faster than you can say “uh-oh.” We specialize in canyon-bottom logistics — and dramatic timing.</p>

          <h3 id="q2" class="common accordion padded">Is it normal for my order to arrive smoking?<img class="icon" src="img/icons/dropdown.png"></h3>
          ...
          <h3 id="q3" class="common accordion padded">What if my package arrives before I do?<img class="icon" src="img/icons/dropdown.png"></h3>
          ...
          <h3 id="q4" class="common accordion padded">How do I track a delivery in mid-air?<img class="icon" src="img/icons/dropdown.png"></h3>
          ...
          <h3 id="q5" class="common accordion padded">Are rocket-propelled deliveries available?<img class="icon" src="img/icons/dropdown.png"></h3>
        ...
        <h2 class="common">PRODUCT QUESTIONS</h2>
          ...
          <h3 id="q6" class="common accordion padded">Do ACME gadgets come with a warranty?<img class="icon" src="img/icons/dropdown.png"></h3>
          <p class="response">Not in the traditional sense, but each ACME product is guaranteed to bring excitement to your life.</p>

          <h3 id="q7" class="common accordion padded">Can I return something if it explodes?<img class="icon" src="img/icons/dropdown.png"></h3>
          <p class="response">Explosions are part of the fun! Unfortunately, we don't offer returns for items that go out with a bang.</p>

          <h3 id="q8" class="common accordion padded">What should I know before using ACME gear?<img class="icon" src="img/icons/dropdown.png"></h3>
          ...
          <h3 id="q9" class="common accordion padded">Are ACME devices tested on real roadrunners?<img class="icon" src="img/icons/dropdown.png"></h3>
          ...
          <h3 id="q10" class="common accordion padded">How do I know if a product is right for my plan?<img class="icon" src="img/icons/dropdown.png"></h3>
