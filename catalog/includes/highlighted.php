<?php
  ...
  echo '<p id="iron-carrot-tagline">Not your garden-variety gadget!</p>';
  echo '<p id="review-1">“Aerodynamic and slightly crunchy. What more could you want?” - Business Insider</p>';
  echo '<p id="review-2">“It\'s not safe, it\'s not quiet, and it\'s definitely not FDA-approved - but wow, is it fun.” - Loyal ACME Customer</p>';
